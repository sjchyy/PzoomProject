...
namespace UserWindow
{
    ...
    {
        public static void RepairWpfWindowFullScreenBehavior(System.Windows.Window wpfWindow)
        {
            if (wpfWindow == null)
            {
                return;
        ...
        private static void WmGetMinMaxInfo(IntPtr hwnd, IntPtr lParam)
        {
            ...
            if (monitor != IntPtr.Zero)
            {
                ...
                mmi.ptMaxPosition.x = Math.Abs(rcWorkArea.left - rcMonitorArea.left)-10;
